/*
 * $Id: stub_main.c 192 2006-10-24 08:51:47Z taka-hir $
 *
...
/* Version Information */
#define DRIVER_VERSION "$Id: stub_main.c 192 2006-10-24 08:51:47Z taka-hir $"
...
kmem_cache_t *stub_priv_cache = NULL;
...
spinlock_t busid_table_lock = SPIN_LOCK_UNLOCKED;
...
static int __init usb_stub_init(void)
{
	...
	driver_create_file(&stub_driver.driver, &driver_attr_match_busid);
...
static void __exit usb_stub_exit(void)
{
	...
	ret = kmem_cache_destroy(stub_priv_cache);
	if (ret != 0) {
