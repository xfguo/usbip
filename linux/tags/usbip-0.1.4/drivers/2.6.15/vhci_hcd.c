/*
 * $Id: vhci_hcd.c 208 2006-11-12 15:22:24Z taka-hir $
 *
...
#define DRIVER_VERSION " $Id: vhci_hcd.c 208 2006-11-12 15:22:24Z taka-hir $ "
 ...
 * CLIENT SIDE
 *
 * - When vhci_hcd recieves RET_SUBMIT,
 *
 ...
 *
 * - When vhci_hcd recieves RET_UNLINK,
 *
 ...
 * SERVER SIDE
 *
 * - When usbip recieves CMD_UNLINK,
 *
 ...
 *		- may be already completed or never be recieved
 *		=> send RET_UNLINK
 *
 */
static int vhci_urb_dequeue(struct usb_hcd *hcd, struct urb *urb)
...
static int vhci_start(struct usb_hcd *hcd)
{
	...
	sysfs_create_group(&vhci_dev(vhci)->kobj, &dev_attr_group);
